...
const services: { id: string; title: string; content: string; img: { src: string; hint: string; }; subServices: SubService[] }[] = [
  {
    ...
    img: {
      ...
      },
      {
        ...
        img: { src: "/images/addiction-and-behavioral-addictions.jpg", hint: "addiction recovery therapy support" }
      },
      {
      ...
      },
      {
        ...
        img: { src: "/images/anger-and-impulse-regulation.jpg", hint: "anger management impulse control therapy" }
      },
      {
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        img: { src: "/images/separation-and-divorce-support.jpg", hint: "divorce support separation counseling healing" }
      }
    ]
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        img: { src: "/images/adolescent-and-teen-counselling.jpg", hint: "adolescent teen counselling youth mental health support" }
      }
    ]
  },
  {
  ...
  },
  {
    ...
    img: {
      ...
      subServices: [
      {
        ...
        img: { src: "/images/intelligence-iq-testing-children-and-adolescents.jpg", hint: "intelligence iq testing child assessment" }
      },
      {
        ...
        img: { src: "/images/learning-disability-assessment-children-and-adolescents.jpg", hint: "learning disability assessment education testing" }
      },
      {
        ...
        img: { src: "/images/autism-spectrum-assessment-children-and-adolescents.jpg", hint: "autism spectrum assessment child development" }
      },
      {
        ...
        img: { src: "/images/adhd-assessment-children-and-adolescents.jpg", hint: "adhd assessment attention focus evaluation" }
      },
      {
      ...
      },
      {
        ...
        img: { src: "/images/vocational-aptitude-and-interest-testing-adults.jpg", hint: "vocational aptitude testing adult career assessment" }
      }
    ]
  }
];
