...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.pramaancare.com"),
  title: "Clinical Psychologist in Gurgaon & Delhi NCR | Pramaan Care",
  description:
    "RCI-registered clinical psychologist offering counselling in Gurgaon & East of Kailash, Delhi NCR, plus secure online therapy across India. Book a session today.",
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/og-pramaan-care.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Clinical Psychologist in Gurgaon & Delhi NCR | Pramaan Care",
    description:
      "Compassionate counselling & online therapy by an RCI-registered clinical psychologist.",
    images: ["/images/og-pramaan-care.jpg"],
  },
  alternates: {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Cabin:ital,wght@0,400..700;1,400..700&family=Forum&family=Onest:wght@100..900&display=swap"
        />

        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-T6DJKQMVB7"
